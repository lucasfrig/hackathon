      ...
      <a class="navbar-brand" href="pagina_inicial.php">PEACH.</a>
      ...
      echo  '<form id="form1" name="form1" method="post" action="[COLOR=Red]frutos_saudavel.php[/COLOR]">';
       
        $F_bd=pg_query($banco, "SELECT NOME, CLASSIFICACAO, PLANTAR, COLHEITA, BENEFICIO FROM ALIMENTO WHERE CLASSIFICACAO LIKE 'Fruto'");
        if (pg_num_rows($F_bd)>0) {   
        ...
        while ($tabela = pg_fetch_array($F_bd)) {
          echo "<tr>";
...
<html>
<head>
  <title>Hortaliças saudaveis</title>
