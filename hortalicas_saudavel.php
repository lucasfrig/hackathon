      ...
      echo  '<form id="form1" name="form1" method="post" action="[COLOR=Red]hortalicas_saudavel.php[/COLOR]">';
       
        $H_bd=pg_query($banco, "SELECT NOME, CLASSIFICACAO, PLANTAR, COLHEITA, BENEFICIO FROM ALIMENTO WHERE CLASSIFICACAO LIKE 'Hortaliça'");
        if (pg_num_rows($H_bd)>0) {   
        ...
        while ($tabela = pg_fetch_array($H_bd)) {
          echo "<tr>";
