      ...
      echo  '<form id="form1" name="form1" method="post" action="[COLOR=Red]alimento_saudavel.php[/COLOR]">';
       
        $P_bd=pg_query($banco, "SELECT NOME, CLASSIFICACAO, PLANTAR, COLHEITA, BENEFICIO FROM ALIMENTO WHERE CLASSIFICACAO LIKE 'Fruta'");
        if (pg_num_rows($P_bd)>0) {   
        ...
        while ($tabela = pg_fetch_array($P_bd)) {
          echo "<tr>";
