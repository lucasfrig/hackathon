...
<body>
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text">PEACH.</h1>
    </div>
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to PEACH.</h1>
      <h2 class="heading--secondary">Você mantém sua saúde em primeiro lugar?</h2>
    </div>
